    ...
    <ScrollReveal direction="up" threshold={0.2}>
      <section id="process" className="container bg-primary text-white overflow-hidden relative">
        ...
        <div className="relative">
          ...
          <StaggerContainer staggerDelay={0.2} delay={0.3}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              {steps.map((step, index) => (
                <StaggerItem key={index} direction="up">
                  <div className="bg-primary rounded-lg min-h-68 p-6 md:p-8 text-center z-10 relative! border border-navy-200/40 flex flex-col justify-between gap-2 group overflow-hidden">
                    <div>
